              ...
              items.map(item => (
                <div key={item.id} className="relative group">
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 p-1.5 bg-white dark:bg-slate-700 rounded-full shadow text-gray-400 hover:text-rose-500 transition-all text-xs"
                    title="削除"
                  >
